...
<html>
  ...
  <body>
    <div class="x-body">
        <form action="${ctx}/activity/insertActivity" method="post" class="layui-form layui-form-pane">
            ...
            <div class="layui-form-item">
                <button class="layui-btn" type="submit" onclick="ChosePage()">
                    增加
                </button>
              </div>
            </form>
