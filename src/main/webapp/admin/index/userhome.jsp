      ...
      <div id="side-nav">
        <ul id="nav">
            ...
            <li class="layui-nav-item">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${ctx}/activity/userListAll">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>所有活动</cite>
                        </a>
                    </li >
                    ...
                    <li>
                        <a _href="${ctx}/examine/userGetMyActivity">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>我负责的活动</cite>
                        </a>
                    </li >
             ...
             <li>
                ...
                <ul class="sub-menu">
                   <li>
                        ...
                        <a _href="${ctx}/apply/findMyApply?sNo=<%=session.getAttribute("user") %>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>申请举办活动</cite>
                        </a>
                    </li>
			...
			<li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${ctx}/admin/index/userinfo.jsp">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>信息更改</cite>
                        </a>
                    </li>                    
